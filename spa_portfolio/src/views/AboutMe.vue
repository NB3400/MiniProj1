    ...
    <div class="about_me_container">
        <div class="text_container">
          ...
          <p class="p_text">
            ...
            pedagógicas inovadoras, procurando fomentar a criatividade, pensamento computacional e resolução de problemas.
          </p>
        </div>
        <div class="img_container">
          <img class="img_profile" src="../assets/profile.png" alt="Imagem de perfil" />
      </div>
    </div>
</template>
